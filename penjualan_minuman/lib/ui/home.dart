...
import 'package:penjualan_minuman/ui/inputpenjualan.dart';
import 'package:penjualan_minuman/models/penjualan.dart';
import 'package:penjualan_minuman/helpers/dbhelper.dart';
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return Card(
          ...
          elevation: 2.0,
          child: ListTile(
            title: Text(this.penjualanList[index].nama, style: textStyle,),
            subtitle: Row(
              children: <Widget>[
                Text(this.penjualanList[index].tanggal),
                Text(" | Rp. "+this.penjualanList[index].harga, style: TextStyle(fontWeight: FontWeight.bold),),
              ],
            ),
